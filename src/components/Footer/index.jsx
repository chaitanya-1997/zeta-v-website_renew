...
const SocialIcons = {
  ...
  youtube: () => (
    <svg viewBox="0 0 24 24" fill="none">
      ...
      <path d="M9.75 15.02L15.5 11.75L9.75 8.48V15.02Z" stroke="currentColor" strokeWidth="1.5"/>
    </svg>
  ),
  instagram: () => (
    <svg viewBox="0 0 24 24" fill="none">
...
const footerLinks = {
  ...
  Resources: ['Blogs', 'Case Studies', 'Technology Insights']
}
  ...
  return (
    <footer className="footer">
      <div className="footer__inner">
        <div className="footer__brand">
          <div className="footer__logo">
            <img src={logoImage} alt="Zeta-V Logo" className="footer__logo-img" />
            <span className="footer__wordmark">ZETA-V</span>
          </div>
          <p className="footer__tagline">Simplifying Solutions. Multiplying Value.</p>
          ...
          <div className="footer__contact">
            ...
            <div className="footer__contact-item">
              <SocialIcons.email />
              <a href="mailto:contact-us@zeta-v.com">contact-us@zeta-v.com</a>
            </div>
            <div className="footer__contact-item">
          ...
          <div className="footer__socials">
            {social.map((s, i) => (
              <a key={i} href={s.href} className="footer__social">
                <s.icon />
              </a>
            ))}
          </div>
      ...
      <div className="footer__bottom">
        <span className="footer__copy">© 2026 <span className="footer__copy-brand">ZETA-V</span>. All rights reserved.</span>
        <div className="footer__legal">
          {legal.map((l, i) => (<a key={i} href="#" className="footer__legal-link">{l}</a>))}
        </div>
      </div>
    </footer>
  )
