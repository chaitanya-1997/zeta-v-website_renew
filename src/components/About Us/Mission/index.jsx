...
//           {/* <span className="text-gradient-mv">Us Forward</span> */}
...
//             </div>
//             {/* Floating badge - Right Bottom for Vision */}
//             <motion.div
...
//               </div>
//               <h3 className="mv-card-title">Becoming the Preferred Partner</h3>
...
//               <div className="mv-image-border" />
//             </div>
//             {/* Floating badge - Left Bottom for Mission */}
//             <motion.div
...
//               </div>
//               <h3 className="mv-card-title">Orchestrating Digital Transformation</h3>
//               <p className="mv-card-description">
