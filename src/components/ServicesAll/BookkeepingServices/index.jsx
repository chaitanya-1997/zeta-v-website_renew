...
// import bookkeepingBg from '../../../assets/images/book.jpg'
// import { CirclePoundSterling } from 'lucide-react'

// // ─── STATS ───
// const stats = [
//   { value: '60%', label: 'Lower Cost Than In-House', icon: HiOutlineCurrencyDollar },
//   { value: '100%', label: 'Data Accuracy', icon: HiOutlineCheckCircle },
...
//   { icon: HiOutlineBuildingOffice, industry: 'Manufacturing', desc: 'Inventory, COGS, production cost tracking' },
//   { icon: HiOutlineBriefcase, industry: 'Professional Services', desc: 'Project profitability and expense management' },
//   { icon: HiOutlineHome, industry: 'Hotels & Hospitality', desc: 'Occupancy, vendor expenses, operational reporting' },
//   { icon: HiOutlineBuildingLibrary, industry: 'Food & Beverage', desc: 'Inventory control and cost analysis' },
//   { icon: HiOutlineShoppingBag, industry: 'E-Commerce', desc: 'Marketplace reconciliation and sales channel reporting' },
//   { icon: HiOutlineShoppingBag, industry: 'Retail', desc: 'Sales tracking and inventory reporting' },
//   { icon: HiOutlineTruck, industry: 'Construction', desc: 'Job costing and project expense tracking' },
//   { icon: HiOutlineWrenchScrewdriver, industry: 'Real Estate', desc: 'Property expense tracking and reporting' },
// ]
...
//                   <span className="bk-price-label">Starting From</span>
//                   <div className="bk-price-amount">
//                     <span className="bk-price-dollar">$</span>999
//                   </div>
...
//                   </p>
//                   <Link to="/calculator" className="bk-btn-primary bk-price-cta">
...
//             </div>
//           </div>
//           <div className="bk-right-contact">
//             <p className="bk-right-contact-label">Professional Bookkeeping Services</p>
//             <div className="bk-right-contact-locations">
//               {locations.map((loc, i) => (
//                 <span key={i} className="bk-right-contact-loc">
//                   {i > 0 && <span className="bk-right-loc-sep">|</span>}
//                   {loc}
//                 </span>
//               ))}
//             </div>
//             <a href="mailto:contactus@zeta-v.com" className="bk-right-contact-link">
//               contactus@zeta-v.com
//             </a>
//             <a href="https://www.zeta-v.com" className="bk-right-contact-link" target="_blank" rel="noreferrer">
//               www.zeta-v.com
//             </a>
//           </div>
//         </div>
...
//                     <p className="bk-industry-card-desc">{item.desc}</p>
//                   </motion.div>
//                 )
//               })}
//             </div>
...
//         {/* SOFTWARE SUPPORTED - Now Dark (changed from White) */}
...
//         {/* GETTING STARTED STEPS - Now Dark (changed from White) */}
...
//             </h2>
//             <div className="bk-steps-grid bk-steps-grid-dark">
//               {getStartedSteps.map((step, i) => (
//                 <motion.div
//                   key={i}
//                   className="bk-step-card bk-step-card-dark"
//                   initial={{ opacity: 0, y: 30 }}
//                   animate={startInView ? { opacity: 1, y: 0 } : {}}
//                   transition={{ delay: i * 0.08, duration: 0.5 }}
//                 >
//                   <div className="bk-step-number bk-step-number-dark">{step.step}</div>
//                   <h3 className="bk-step-title bk-step-title-dark">{step.title}</h3>
//                   <p className="bk-step-desc bk-step-desc-dark">{step.desc}</p>
//                 </motion.div>
//               ))}
//             </div>
//           </div>
...
//         {/* FINAL CTA - Now White (changed from Dark) */}
...
// ─── Reusable Price CTA Banner ───
const PriceCtaBanner = ({ align = 'center' }) => (
  <div className={`bk-price-cta-banner bk-price-cta-${align}`}>
    <div className="bk-price-cta-content">
      <p className="bk-price-cta-text">
        Not sure about pricing? Get a custom quote tailored to your business.
      </p>
...
export default function BookkeepingServices() {
  ...
  <HiArrowRight />
        ...
        {/* PRICE CTA after Final CTA (last section) */}
        <PriceCtaBanner align="center" />
